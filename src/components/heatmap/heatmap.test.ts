...
describe('RegionalIntelligencePanel — heatmap preview integration', () => {
  ...
  it('imports getProductionEngineKeys from analytics engine (registry-driven KPI columns, Stabilization Pass)', () => {
    expect(PANEL_SRC).toContain('getProductionEngineKeys')
  })
