// ============================================================
// BasketForm — Basket field inputs + validation (Phase 2F)
//
...
export const DEFAULT_BASKET_FORM_VALUES = {
  label:       '',
  weight:      '1',
  description: '',
}
...
/**
 * Validates basket form values. Trims whitespace. Never throws.
 * Returns { valid, errors }.
 */
export function validateBasketForm(values) {
  const errors = {}
...
export default function BasketForm({ values, errors = {}, onChange, disabled = false }) {
    ...
    <div>
      ...
      <Field label="Description (optional)">
        <textarea
          ...
          disabled={disabled}
          rows={2}
          placeholder="Short description of this basket"
